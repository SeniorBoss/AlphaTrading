  ...
  return (
    <div className='w-full md:h-[700px]  bg-gray-200 flex justify-center items-center flex-col gap-8' ref={ref}>
     <div className='flex flex-col items-center gap-3'>
      <h1 className='font-bold text-2xl'>Mentorship</h1>
      <h1>Join our unique Lifetime Mentorship Program</h1>
     </div>

      <div className='w-[86%] md:h-[80%]  bg-gray-200 md:flex md:justify-between'>
      <div className='md:w-[30%] md:h-[80%] ms:w-[100%] ms:h-[450px] bg-black rounded-2xl bg-[url("./src/assets/Zoom.jpg")] bg-cover bg-center bg-no-repeat ms:mb-10'>
        <div className='w-full h-full bg-black opacity-80 rounded-2xl flex flex-col items-center justify-center gap-8'>
          ...
          <div className='w-[50%] flex flex-col items-center'>
            ...
            <p className=' text-white'>For registration</p>
          </div>
          ...
          <div className='w-full h-[30%] border-t-2 border-white pt-5 pl-5 '>
            <h1 className='font-bold text-xl text-white'>Include</h1>
            <p className=' text-white'>Lifetime Mentorship Physical or Online Mentorship One-time Fee</p>
          </div>
        </div>
     </div>

     <div className='md:w-[30%] md:h-[80%] ms:w-[100%] ms:h-[450px] bg-black rounded-2xl bg-[url("./src/assets/Zoom2.jpg")] bg-cover bg-center bg-no-repeat ms:mb-10'>
          <div className='w-full h-full bg-black opacity-80 rounded-2xl flex flex-col items-center justify-center gap-8'>
          ...
          <div className='w-[50%] flex flex-col items-center'>
            ...
            <p className=' text-white'>One term fee</p>
          </div>
     ...
     <div className='md:w-[30%] md:h-[80%] ms:w-[100%] ms:h-[450px] bg-black rounded-2xl bg-[url("./src/assets/Zoom3.jpg")] bg-cover bg-center bg-no-repeat ms:mb-10'>
