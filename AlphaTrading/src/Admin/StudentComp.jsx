      ...
      <div className='w-full h-max bg-white rounded-2xl flex flex-col items-center gap-3'>
            <div className='w-[90%] h-[22%]  flex  justify-between items-center'>
                ...
                <div className=' w-[20%] h-[80%] flex justify-between'>
                    <div className=' w-[50%] h-full items-center justify-center flex flex-col border-r-2'>
                        <h1 className=' text-3xl font-bold'>111</h1>
            ...
            <div className='w-[90%] h-max flex flex-col gap-1 relative'>
                <div className='w-full h-[40px] flex justify-between items-center'>
                    ...
                    <h1 type='number' className='w-[30px] h-[20px] border-2 flex items-center justify-center'>33</h1>
                    </div>

                    <div className='w-[18%] h-[70%] items-center flex '>
                    <h1 type='number' className='w-[30px] h-[20px] border-2 flex items-center justify-center'>35</h1>
                    </div>

                    <div className='w-[18%] h-[70%] items-center flex '>
                    <h1 type='number' className='w-[30px] h-[20px] border-2 flex items-center justify-center'>55</h1>
                    </div>
                    
                    <div className='w-[19%] h-[100%] items-center flex'>
                    <button className='w-[80px] h-[26px] bg-black text-white rounded-xl font-bold text-xs cursor-pointer'>Paid</button>
                    </div>
                </div>
                <div className='w-full h-[40px] flex justify-between items-center'>
                    <div className='w-[25%] h-[70%] items-center flex  gap-2'>
                ...
                <div className='w-full h-[40px] flex justify-between items-center'>
                    ...
                    <div className='w-[19%] h-[100%] items-center flex'>
                    <button className='w-[80px] h-[26px] bg-black text-white rounded-xl font-bold text-xs cursor-pointer'>Completed</button>
                    </div>
                </div>
                <div className='w-full h-[40px] flex justify-between items-center'>
                    <div className='w-[25%] h-[70%] items-center flex  gap-2'>
