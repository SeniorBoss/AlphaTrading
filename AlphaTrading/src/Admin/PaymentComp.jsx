...
export const PaymentComp = () => {
    ...
    const fetchStudents = async () => {
        try {
            ...
            const response = await axios.get("https://alpha-trading.onrender.com/api/admin/all-students", {
                headers: {
                    ...
                    <div className='w-full h-max bg-white rounded-2xl flex flex-col items-center gap-3'>
                        ...
                        <div className='w-[90%] h-max flex flex-col gap-1 relative'>
                            {students.map((student, index) => (
                                <div key={index} className='w-full h-[40px] flex justify-between items-center'>
                                    <div className='w-[27%] h-[70%] items-center flex  gap-2'>
                                        ...
                                        <h1 className=' text-sm'>{student.firstName} {student.lastName}</h1>
                                    </div>
                                    ...
                                    <div className='w-[19%] h-[100%] items-center justify-center flex gap-5'>
                                        <button className='w-[80px] h-[26px] bg-white text-black rounded-xl font-bold text-xs cursor-pointer border-2 border-black'>Decline</button>
